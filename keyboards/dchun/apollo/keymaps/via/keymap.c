...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
    ...
    KC_LCTL, KC_SPC , KC_LGUI, KC_LALT, KC_BSPC,  KC_ENT,  KC_SPC,   MO(1), KC_LEFT, KC_DOWN,   KC_UP,KC_RIGHT, \
                                                  KC_DEL,  KC_ENT \
  ),
  ...
  [_ADJ] =  LAYOUT( \
    ...
    _______, _______, _______, _______, _______, _______, _______,   KC_P0, KC_PDOT, KC_NLCK, _______, _______, \
                                                 _______, _______ \
  )
};
